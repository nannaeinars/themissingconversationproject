...
namespace TheMissingConversationProject.Controllers
{
    ...
    {
        private TheMissingConversationProjectContext db = new TheMissingConversationProjectContext();
        ...
        public ActionResult Create([Bind(Include = "ConversationId,FirstPerson,SecondPerson,DateAdded")] Conversation conversation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ConversationId,FirstPerson,SecondPerson,DateAdded")] Conversation conversation)
        {
            if (ModelState.IsValid)
            {
